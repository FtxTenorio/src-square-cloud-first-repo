/**
 * Slash Command Definitions for all bot features
 */
...
export const personalityCommand = {
    ...
    async execute(interaction) {
        ...
        aiService.setUserPersonality(interaction.user.id, personality);
        const personalities = aiService.PERSONALITIES;
...
export const helpCommand = {
    ...
    async execute(interaction) {
        const embed = new EmbedBuilder()
            ...
            .setFooter({ text: 'Você também pode conversar comigo diretamente!' })
            .setTimestamp();
